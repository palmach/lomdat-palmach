...
var arrBeforeText = [
    ...
    },
    {
        ...
        "text": "<p class='before-p before-instructions'>בפעילות הקרובה אתם הולכים לעבור מספר משימות.<br>בכל משימה יהיה שעון שאומר תוך כמה זמן תתבקשו לסיים את המשימה, סיום לפני הזמן יזכה אתכם בנקודות נוספות.<br>אל חשש- בזמן שההסבר מוצג הזמ ייעצר ויימשך בסיומו.</p>",
        "button": "בואו נתחיל"
    },
    {
